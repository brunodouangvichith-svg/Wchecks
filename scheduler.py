...
from collectors import (
    ...
    collect_newspapers_libye,
    collect_newspapers_norvege,
    collect_newspapers_soudan,
    collect_newspapers_syrie,
    collect_newspapers_venezuela,
    collect_newspapers_yemen,
...
JOBS = [
    ...
    # 9 sous-agents dédiés par pays (voir collect_national_newspapers_contents.
    # _EXCLUDED_COUNTRIES : ces pays sont exclus du sous-agent générique).
    ("newspapers_angola", config.FREQUENCIES_MINUTES["newspapers_country_dedicated"], collect_newspapers_angola.run),
    (
        "newspapers_azerbaidjan",
        config.FREQUENCIES_MINUTES["newspapers_country_dedicated"],
        collect_newspapers_azerbaidjan.run,
    ),
    ("newspapers_grece", config.FREQUENCIES_MINUTES["newspapers_country_dedicated"], collect_newspapers_grece.run),
    ("newspapers_libye", config.FREQUENCIES_MINUTES["newspapers_country_dedicated"], collect_newspapers_libye.run),
    ("newspapers_norvege", config.FREQUENCIES_MINUTES["newspapers_country_dedicated"], collect_newspapers_norvege.run),
    ("newspapers_soudan", config.FREQUENCIES_MINUTES["newspapers_country_dedicated"], collect_newspapers_soudan.run),
    ("newspapers_syrie", config.FREQUENCIES_MINUTES["newspapers_country_dedicated"], collect_newspapers_syrie.run),
    (
        "newspapers_venezuela",
        config.FREQUENCIES_MINUTES["newspapers_country_dedicated"],
